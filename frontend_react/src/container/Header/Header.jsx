  ...
  <div className="app__header app__flex">
    <div className='header-aboutsection'>
      ...
      <div className="header-text">
        <h2>I am a motivated <span>software developer/data analyst</span> with experience in analyzing and finding hidden insights in the data, visualizing reports, and building prediction models. <br/>Skilled in machine learning, ETL, data visualization, problem-solving, and programming.</h2>
      </div>
